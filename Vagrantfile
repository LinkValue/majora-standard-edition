...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.define :local, primary: true do |local|
        ...
        local.vm.network "private_network", ip: "192.168.100.60"
        ...
        local.vm.synced_folder ".", "/var/www/majora-standard-edition/", id:"vagrant-root", type: "nfs", mount_options: ["nolock,vers=3,udp,noatime,actimeo=1"]
    end
